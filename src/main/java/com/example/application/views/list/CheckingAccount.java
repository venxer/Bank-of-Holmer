...
public class CheckingAccount 
{
    ...
    private String[][] tenRecentTransactionLog = new String[10][4]; //Time, Reciever Username, reciver firstname, ammount 
    ...
    public static String recipientExist(String username, String lastName)
    {
        if(Account.accExist(username)) //checks if recipient with username exists
        {
            ...
            if(Account.arrayListIndex(Account.getUsernameList(), username) == Account.arrayListIndex(Account.getLastNameList(), lastName)) //correct Last name
            {
